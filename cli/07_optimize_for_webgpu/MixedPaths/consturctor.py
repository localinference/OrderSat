...
WEBGPU_MIXED_ROOT = pathlib.Path("src/08_mixed-fp16_gpu_onnx_models")
...
def build_mixed_paths(language: str) -> QuantizationPaths:
    ...
    return QuantizationPaths(
        ...
        mixed_model_external_data_path=mixed_dir
        / f"{MIXED_MODEL_NAME}.data",
