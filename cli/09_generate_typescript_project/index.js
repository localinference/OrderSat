...
const webgpuModelPath = `./src/07_mixed-fp16_gpu_onnx_models/${language}/model.mixed-fp16.onnx`
const wasmModelPath = `./src/08_uint8_cpu_onnx_models/${language}/model.uint8.onnx`
